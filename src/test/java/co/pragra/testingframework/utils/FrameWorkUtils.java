package co.pragra.testingframework.utils;
...
public class FrameWorkUtils {
    ...
    public static void takeScreenShot(WebDriver driver, String tcName){
    ...
    public static String getFileName(String tcName){
